...
module.exports = (firstName) => 
	sample([
		...
		"I was sent pictures of it",
		`I saw pictures of it on ${sample(socialMedia)}`,
		`I hear about the news on ${sample(socialMedia)}`,
		...
		`One of our coworkers told me about it who is close with ${firstName}`,
